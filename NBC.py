...
#     feature_wordss = open("feature_words.txt", 'w')
#     matrix_feature = open("matrix_fea.txt", 'w')
#
#     for i in train_data_list:
#         print (i)
#         break
...
#         temp = str(item).strip('[').strip(']').replace(' ', '')
#         feature_wordss.write(temp + '\n')
#     feature_wordss.close()
#
...
#     train_path = "./training/"
#     test_path = "./test/"
#     all_words_list, train_data_list, test_data_list, train_class_list, test_class_list = TextProcessingsep(train_path,
#                                                                                                            test_path,
#                                                                                                            test_size=0.2)
#
#     # 生成stopwords_set
